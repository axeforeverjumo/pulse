  ...
  return (
    <div className="flex-1 flex flex-col min-w-0 overflow-hidden">
      ...
      <div className="flex-1 overflow-auto p-5">
        <p className="text-[9.5px] font-bold tracking-[0.13em] uppercase text-text-tertiary mb-3">Tu squad de asesores</p>
          ...
          {mentors.map((m) => (
            <div key={m.name} className="p-4 rounded-xl border border-border-light bg-bg-white hover:border-border-gray transition-all cursor-pointer group">
              <div className="flex items-start gap-3 mb-3">
                ...
                <div>
                  <p className="text-[12px] font-bold text-text-dark">{m.name}</p>
              ...
              <span className="text-[8.5px] font-bold tracking-[0.08em] uppercase px-2 py-0.5 rounded-full bg-bg-gray text-text-tertiary inline-block mb-2">{m.focus}</span>
