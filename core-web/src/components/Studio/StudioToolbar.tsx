...
import { useSaveStudioPageTree, useStudioApp } from '../../hooks/queries/useStudio';
...
export default function StudioToolbar() {
  ...
  const { data: app } = useStudioApp(activeAppId);
    ...
    <>
      <div className="flex items-center justify-between h-11 px-3 bg-white border-b border-gray-200 shrink-0">
        ...
        <div className="flex items-center gap-2">
          ...
          {app && (
            <span className="text-[13px] font-medium text-gray-700 ml-1">{app.name}</span>
          )}
